          ...
          <div className="submitBtn">
            <BasicButton
              ...
              onClick={() => {
                ...
                //   ...modal.defaultModal,
                //   show: true,
                //   title: "개인정보취급방침에 동의해 주세요.",
                //   text: "개인정보 사용에 대한 동의가 필요합니다. 약관을\n확인해 주세요.",
                //   subBtnText: "확인",
                // });
                // --- 첨부 파일 조건 확인
                // modal.setDefaultModal({
                //   ...modal.defaultModal,
                //   show: true,
                //   title: "첨부 파일 조건을 확인해 주세요.",
                //   text: "최대 200mb 이내로 zip, pdf, docx, hwp 파일만 첨부가 가능합니다.",
                //   subBtnText: "확인",
                // });
                // --- 완료
                modal.setDefaultModal({
                  ...
                  show: true,
                  title: "문의가 완료되었습니다.",
                  text: "담당자 확인 후 영업일 기준 3~5일 이내로 개별 연락드리도록 하겠습니다. 감사합니다.",
                  mainBtnText: "메인으로",
                  mainBtnClick() {
                    router.push("/");
                  },
      ...
      <div className="faqLink">
        <LinkBox
          data={{
            href: "/voc/faq",
            title: "FAQ",
            desc: "VOC에 대해 자주 묻는 질문을 확인해 보세요!",
            bg: BgFaq.src,
          }}
        />
      </div>
